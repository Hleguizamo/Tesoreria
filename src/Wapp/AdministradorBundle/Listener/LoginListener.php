<?php
namespace Wapp\AdministradorBundle\Listener;
...
use Wapp\AdministradorBundle\Entity\AuthAdministrador;
...
class LoginListener implements AuthenticationSuccessHandlerInterface, AuthenticationFailureHandlerInterface, LogoutSuccessHandlerInterface {
    ...
    function onAuthenticationSuccess(Request $request, TokenInterface $token){
        ...
        $uri = $this->container->get('router')->generate('administrador_index');
